...
const FunctionInfo = `[{"package":"test","module":"complex","name":"check_string","parameters":[{"name":"input","type":"string"}]},{"package":"test","module":"complex","name":"check_u128","parameters":[{"name":"input","type":"*big.Int"}]},{"package":"test","module":"complex","name":"check_u256","parameters":[{"name":"input","type":"*big.Int"}]},{"package":"test","module":"complex","name":"check_with_mut_object_ref","parameters":[{"name":"obj","type":"bind.Object"},{"name":"new_number","type":"uint64"}]},{"package":"test","module":"complex","name":"check_with_object_ref","parameters":[{"name":"obj","type":"bind.Object"}]},{"package":"test","module":"complex","name":"flatten_address","parameters":[{"name":"some_address","type":"string"},{"name":"some_addresses","type":"[]string"}]},{"package":"test","module":"complex","name":"flatten_string","parameters":[{"name":"input","type":"[][]string"}]},{"package":"test","module":"complex","name":"flatten_u8","parameters":[{"name":"input","type":"[][]byte"}]},{"package":"test","module":"complex","name":"new_object","parameters":[{"name":"some_id","type":"[]byte"},{"name":"some_number","type":"uint64"},{"name":"some_address","type":"string"},{"name":"some_addresses","type":"[]string"}]},{"package":"test","module":"complex","name":"new_object_with_transfer","parameters":[{"name":"some_id","type":"[]byte"},{"name":"some_number","type":"uint64"},{"name":"some_address","type":"string"},{"name":"some_addresses","type":"[]string"}]}]`
