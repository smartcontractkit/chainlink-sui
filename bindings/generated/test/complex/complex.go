...
const FunctionInfo = `[{"package":"test","module":"complex","name":"check_string","parameters":[{"name":"input","type":"0x1::string::String"}]},{"package":"test","module":"complex","name":"check_u128","parameters":[{"name":"input","type":"u128"}]},{"package":"test","module":"complex","name":"check_u256","parameters":[{"name":"input","type":"u256"}]},{"package":"test","module":"complex","name":"check_with_mut_object_ref","parameters":[{"name":"obj","type":"SampleObject"},{"name":"new_number","type":"u64"}]},{"package":"test","module":"complex","name":"check_with_object_ref","parameters":[{"name":"obj","type":"SampleObject"}]},{"package":"test","module":"complex","name":"flatten_address","parameters":[{"name":"some_address","type":"address"},{"name":"some_addresses","type":"vector<address>"}]},{"package":"test","module":"complex","name":"flatten_string","parameters":[{"name":"input","type":"vector<vector<String>>"}]},{"package":"test","module":"complex","name":"flatten_u8","parameters":[{"name":"input","type":"vector<vector<u8>>"}]},{"package":"test","module":"complex","name":"new_object","parameters":[{"name":"some_id","type":"vector<u8>"},{"name":"some_number","type":"u64"},{"name":"some_address","type":"address"},{"name":"some_addresses","type":"vector<address>"}]},{"package":"test","module":"complex","name":"new_object_with_transfer","parameters":[{"name":"some_id","type":"vector<u8>"},{"name":"some_number","type":"u64"},{"name":"some_address","type":"address"},{"name":"some_addresses","type":"vector<address>"}]}]`
