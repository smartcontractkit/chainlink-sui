...
const FunctionInfo = `[{"package":"test","module":"onramp","name":"emit_allowlist_senders_added_event","parameters":[{"name":"dest_chain_selector","type":"u64"}]},{"package":"test","module":"onramp","name":"emit_allowlist_senders_removed_event","parameters":[{"name":"dest_chain_selector","type":"u64"}]},{"package":"test","module":"onramp","name":"emit_ccip_message_sent_event","parameters":[{"name":"dest_chain_selector","type":"u64"},{"name":"sequence_number","type":"u64"}]},{"package":"test","module":"onramp","name":"emit_config_set_event","parameters":null},{"package":"test","module":"onramp","name":"emit_dest_chain_config_set_event","parameters":null},{"package":"test","module":"onramp","name":"emit_fee_token_withdrawn_event","parameters":null}]`
...
func init() {
	...
	bind.RegisterStructDecoder("vector<test::onramp::ConfigSet>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::DestChainConfigSet>", func(data []byte) (interface{}, error) {
		var results []DestChainConfigSet
	...
	bind.RegisterStructDecoder("vector<test::onramp::CCIPMessageSent>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::AllowlistSendersAdded>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::AllowlistSendersRemoved>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::FeeTokenWithdrawn>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::OnRampState>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::StaticConfig>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::DynamicConfig>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::DestChainConfig>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::RampMessageHeader>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::Sui2AnyRampMessage>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<test::onramp::Sui2AnyTokenTransfer>", func(data []byte) (interface{}, error) {
