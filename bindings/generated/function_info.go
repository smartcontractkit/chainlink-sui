...
import (
    ...
    module_burn_mint_token_pool "github.com/smartcontractkit/chainlink-sui/bindings/generated/ccip/ccip_malicious_token_pool/burn_mint_token_pool"
...
var FunctionInfoByModule = map[string]string{
    ...
    "mcms_deployer": module_mcms_deployer.FunctionInfo,
    "mcms_registry": module_mcms_registry.FunctionInfo,
    "mcms_user": module_mcms_user.FunctionInfo,
    "complex": module_complex.FunctionInfo,
    "counter": module_counter.FunctionInfo,
    "generics": module_generics.FunctionInfo,
}