...
const FunctionInfo = `[{"package":"mcms","module":"mcms_account","name":"accept_ownership","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"mcms","module":"mcms_account","name":"accept_ownership_as_timelock","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"mcms","module":"mcms_account","name":"accept_ownership_from_object","parameters":[{"name":"state","type":"bind.Object"},{"name":"from","type":"string"}]},{"package":"mcms","module":"mcms_account","name":"execute_ownership_transfer","parameters":[{"name":"owner_cap","type":"bind.Object"},{"name":"state","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"to","type":"string"}]},{"package":"mcms","module":"mcms_account","name":"owner","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"mcms","module":"mcms_account","name":"pending_transfer_accepted","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"mcms","module":"mcms_account","name":"pending_transfer_from","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"mcms","module":"mcms_account","name":"pending_transfer_to","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"mcms","module":"mcms_account","name":"transfer_ownership","parameters":[{"name":"_","type":"bind.Object"},{"name":"state","type":"bind.Object"},{"name":"to","type":"string"}]},{"package":"mcms","module":"mcms_account","name":"transfer_ownership_to_self","parameters":[{"name":"owner_cap","type":"bind.Object"},{"name":"state","type":"bind.Object"}]}]`
