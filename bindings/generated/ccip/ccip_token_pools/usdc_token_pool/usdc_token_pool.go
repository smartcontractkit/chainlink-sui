...
type UsdcTokenPoolEncoder interface {
	...
	Initialize(typeArgs []string, ref bind.Object, ccipAdminProof bind.Object, localDomainIdentifier uint32, tokenPoolPackageId string, tokenPoolAdministrator string, decimals byte) (*bind.EncodedCall, error)
...
func (c *UsdcTokenPoolContract) Initialize(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, ccipAdminProof bind.Object, localDomainIdentifier uint32, tokenPoolPackageId string, tokenPoolAdministrator string, decimals byte) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.usdcTokenPoolEncoder.Initialize(typeArgs, ref, ccipAdminProof, localDomainIdentifier, tokenPoolPackageId, tokenPoolAdministrator, decimals)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c usdcTokenPoolEncoder) Initialize(typeArgs []string, ref bind.Object, ccipAdminProof bind.Object, localDomainIdentifier uint32, tokenPoolPackageId string, tokenPoolAdministrator string, decimals byte) (*bind.EncodedCall, error) {
