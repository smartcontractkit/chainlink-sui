...
type UsdcTokenPoolEncoder interface {
	...
	Initialize(typeArgs []string, ownerCap bind.Object, ref bind.Object, coinMetadata bind.Object, tokenPoolAdministrator string, localDomainIdentifier uint32) (*bind.EncodedCall, error)
...
func (c *UsdcTokenPoolContract) Initialize(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ownerCap bind.Object, ref bind.Object, coinMetadata bind.Object, tokenPoolAdministrator string, localDomainIdentifier uint32) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.usdcTokenPoolEncoder.Initialize(typeArgs, ownerCap, ref, coinMetadata, tokenPoolAdministrator, localDomainIdentifier)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c usdcTokenPoolEncoder) Initialize(typeArgs []string, ownerCap bind.Object, ref bind.Object, coinMetadata bind.Object, tokenPoolAdministrator string, localDomainIdentifier uint32) (*bind.EncodedCall, error) {
