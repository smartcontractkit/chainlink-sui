...
type UsdcTokenPoolEncoder interface {
	...
	InitializeByCcipAdmin(typeArgs []string, ownerCap bind.Object, ref bind.Object, ccipAdminProof bind.Object, coinMetadata bind.Object, publisher bind.Object) (*bind.EncodedCall, error)
...
func (c *UsdcTokenPoolContract) InitializeByCcipAdmin(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ownerCap bind.Object, ref bind.Object, ccipAdminProof bind.Object, coinMetadata bind.Object, publisher bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.usdcTokenPoolEncoder.InitializeByCcipAdmin(typeArgs, ownerCap, ref, ccipAdminProof, coinMetadata, publisher)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c usdcTokenPoolEncoder) InitializeByCcipAdmin(typeArgs []string, ownerCap bind.Object, ref bind.Object, ccipAdminProof bind.Object, coinMetadata bind.Object, publisher bind.Object) (*bind.EncodedCall, error) {
