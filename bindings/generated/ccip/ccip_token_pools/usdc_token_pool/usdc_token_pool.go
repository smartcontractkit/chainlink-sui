...
func (c *UsdcTokenPoolContract) InitializeByCcipAdmin(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, ccipAdminProof bind.Object, coinMetadata bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.usdcTokenPoolEncoder.InitializeByCcipAdmin(typeArgs, ref, ccipAdminProof, coinMetadata)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c usdcTokenPoolEncoder) InitializeByCcipAdmin(typeArgs []string, ref bind.Object, ccipAdminProof bind.Object, coinMetadata bind.Object) (*bind.EncodedCall, error) {
