...
type IManagedTokenPool interface {
	...
	InitializeByCcipAdmin(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, ownerCap bind.Object, coinMetadata bind.Object, mintCap bind.Object, managedTokenPoolPackageId string, tokenPoolAdministrator string) (*models.SuiTransactionBlockResponse, error)
	...
	LockOrBurn(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, c_ bind.Object, tokenParams bind.Object, clock bind.Object, state bind.Object, denyList bind.Object, tokenState bind.Object) (*models.SuiTransactionBlockResponse, error)
	ReleaseOrMint(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, receiverParams bind.Object, index uint64, clock bind.Object, pool bind.Object, tokenState bind.Object, denyList bind.Object) (*models.SuiTransactionBlockResponse, error)
...
type IManagedTokenPoolDevInspect interface {
	...
	ReleaseOrMint(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, receiverParams bind.Object, index uint64, clock bind.Object, pool bind.Object, tokenState bind.Object, denyList bind.Object) (bind.Object, error)
...
type ManagedTokenPoolEncoder interface {
	...
	InitializeByCcipAdmin(typeArgs []string, ref bind.Object, ownerCap bind.Object, coinMetadata bind.Object, mintCap bind.Object, managedTokenPoolPackageId string, tokenPoolAdministrator string) (*bind.EncodedCall, error)
	...
	LockOrBurn(typeArgs []string, ref bind.Object, c_ bind.Object, tokenParams bind.Object, clock bind.Object, state bind.Object, denyList bind.Object, tokenState bind.Object) (*bind.EncodedCall, error)
	LockOrBurnWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error)
	ReleaseOrMint(typeArgs []string, ref bind.Object, receiverParams bind.Object, index uint64, clock bind.Object, pool bind.Object, tokenState bind.Object, denyList bind.Object) (*bind.EncodedCall, error)
...
func (c *ManagedTokenPoolContract) BuildPTB(ctx context.Context, ptb *transaction.Transaction, encoded *bind.EncodedCall) (*transaction.Argument, error) {
...
func (c *ManagedTokenPoolContract) InitializeByCcipAdmin(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, ownerCap bind.Object, coinMetadata bind.Object, mintCap bind.Object, managedTokenPoolPackageId string, tokenPoolAdministrator string) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.managedTokenPoolEncoder.InitializeByCcipAdmin(typeArgs, ref, ownerCap, coinMetadata, mintCap, managedTokenPoolPackageId, tokenPoolAdministrator)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *ManagedTokenPoolContract) LockOrBurn(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, c_ bind.Object, tokenParams bind.Object, clock bind.Object, state bind.Object, denyList bind.Object, tokenState bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.managedTokenPoolEncoder.LockOrBurn(typeArgs, ref, c_, tokenParams, clock, state, denyList, tokenState)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *ManagedTokenPoolContract) ReleaseOrMint(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, receiverParams bind.Object, index uint64, clock bind.Object, pool bind.Object, tokenState bind.Object, denyList bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.managedTokenPoolEncoder.ReleaseOrMint(typeArgs, ref, receiverParams, index, clock, pool, tokenState, denyList)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *ManagedTokenPoolContract) McmsRegisterEntrypoint(ctx context.Context, opts *bind.CallOpts, typeArgs []string, registry bind.Object, state bind.Object, ownerCap bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.managedTokenPoolEncoder.McmsRegisterEntrypoint(typeArgs, registry, state, ownerCap)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *ManagedTokenPoolContract) McmsEntrypoint(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.managedTokenPoolEncoder.McmsEntrypoint(typeArgs, state, registry, params)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (d *ManagedTokenPoolDevInspect) ReleaseOrMint(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, receiverParams bind.Object, index uint64, clock bind.Object, pool bind.Object, tokenState bind.Object, denyList bind.Object) (bind.Object, error) {
	encoded, err := d.contract.managedTokenPoolEncoder.ReleaseOrMint(typeArgs, ref, receiverParams, index, clock, pool, tokenState, denyList)
	if err != nil {
...
func (c managedTokenPoolEncoder) InitializeByCcipAdmin(typeArgs []string, ref bind.Object, ownerCap bind.Object, coinMetadata bind.Object, mintCap bind.Object, managedTokenPoolPackageId string, tokenPoolAdministrator string) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c managedTokenPoolEncoder) LockOrBurn(typeArgs []string, ref bind.Object, c_ bind.Object, tokenParams bind.Object, clock bind.Object, state bind.Object, denyList bind.Object, tokenState bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c managedTokenPoolEncoder) ReleaseOrMint(typeArgs []string, ref bind.Object, receiverParams bind.Object, index uint64, clock bind.Object, pool bind.Object, tokenState bind.Object, denyList bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c managedTokenPoolEncoder) McmsRegisterEntrypoint(typeArgs []string, registry bind.Object, state bind.Object, ownerCap bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c managedTokenPoolEncoder) McmsRegisterEntrypointWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut Registry",
		"&mut ManagedTokenPoolState<T>",
		"OwnerCap",
...
func (c managedTokenPoolEncoder) McmsEntrypoint(typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c managedTokenPoolEncoder) McmsEntrypointWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut ManagedTokenPoolState<T>",
		"&mut Registry",
		"ExecutingCallbackParams",
