...
const FunctionInfo = `[{"package":"lock_release_token_pool","module":"token_pool","name":"add_remote_pool","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selector","type":"u64"},{"name":"remote_pool_address","type":"vector<u8>"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"apply_allowlist_updates","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"removes","type":"vector<address>"},{"name":"adds","type":"vector<address>"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"apply_chain_updates","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selectors_to_remove","type":"vector<u64>"},{"name":"remote_chain_selectors_to_add","type":"vector<u64>"},{"name":"remote_pool_addresses_to_add","type":"vector<vector<vector<u8>>>"},{"name":"remote_token_addresses_to_add","type":"vector<vector<u8>>"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"calculate_local_amount","parameters":[{"name":"remote_amount","type":"u256"},{"name":"remote_decimals","type":"u8"},{"name":"local_decimals","type":"u8"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"calculate_release_or_mint_amount","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"source_pool_data","type":"vector<u8>"},{"name":"source_amount","type":"u256"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"destroy_token_pool","parameters":[{"name":"state","type":"TokenPoolState"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"emit_liquidity_added","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"provider","type":"address"},{"name":"amount","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"emit_liquidity_removed","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"provider","type":"address"},{"name":"amount","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"emit_locked_or_burned","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"amount","type":"u64"},{"name":"remote_chain_selector","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"emit_rebalancer_set","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"previous_rebalancer","type":"address"},{"name":"rebalancer","type":"address"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"emit_released_or_minted","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"recipient","type":"address"},{"name":"amount","type":"u64"},{"name":"remote_chain_selector","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"encode_local_decimals","parameters":[{"name":"coin_metadata","type":"CoinMetadata<T>"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_allowlist","parameters":[{"name":"state","type":"TokenPoolState"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_allowlist_enabled","parameters":[{"name":"state","type":"TokenPoolState"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_current_inbound_rate_limiter_state","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"clock","type":"Clock"},{"name":"remote_chain_selector","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_current_outbound_rate_limiter_state","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"clock","type":"Clock"},{"name":"remote_chain_selector","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_local_decimals","parameters":[{"name":"pool","type":"TokenPoolState"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_remote_pools","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selector","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_remote_token","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selector","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_supported_chains","parameters":[{"name":"state","type":"TokenPoolState"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_symbol","parameters":[{"name":"state","type":"TokenPoolState"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"get_token","parameters":[{"name":"state","type":"TokenPoolState"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"initialize","parameters":[{"name":"coin_metadata_address","type":"address"},{"name":"local_decimals","type":"u8"},{"name":"symbol","type":"ascii::String"},{"name":"allowlist","type":"vector<address>"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"is_remote_pool","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selector","type":"u64"},{"name":"remote_pool_address","type":"vector<u8>"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"is_supported_chain","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selector","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"parse_remote_decimals","parameters":[{"name":"source_pool_data","type":"vector<u8>"},{"name":"local_decimals","type":"u8"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"remove_remote_pool","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selector","type":"u64"},{"name":"remote_pool_address","type":"vector<u8>"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"set_allowlist_enabled","parameters":[{"name":"state","type":"TokenPoolState"},{"name":"enabled","type":"bool"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"set_chain_rate_limiter_config","parameters":[{"name":"clock","type":"Clock"},{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selector","type":"u64"},{"name":"outbound_is_enabled","type":"bool"},{"name":"outbound_capacity","type":"u64"},{"name":"outbound_rate","type":"u64"},{"name":"inbound_is_enabled","type":"bool"},{"name":"inbound_capacity","type":"u64"},{"name":"inbound_rate","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"validate_lock_or_burn","parameters":[{"name":"ref","type":"CCIPObjectRef"},{"name":"clock","type":"Clock"},{"name":"state","type":"TokenPoolState"},{"name":"sender","type":"address"},{"name":"remote_chain_selector","type":"u64"},{"name":"local_amount","type":"u64"}]},{"package":"lock_release_token_pool","module":"token_pool","name":"validate_release_or_mint","parameters":[{"name":"ref","type":"CCIPObjectRef"},{"name":"clock","type":"Clock"},{"name":"state","type":"TokenPoolState"},{"name":"remote_chain_selector","type":"u64"},{"name":"dest_token_address","type":"address"},{"name":"source_pool_address","type":"vector<u8>"},{"name":"local_amount","type":"u64"}]}]`

type ITokenPool interface {
	Initialize(ctx context.Context, opts *bind.CallOpts, coinMetadataAddress string, localDecimals byte, symbol string, allowlist []string) (*models.SuiTransactionBlockResponse, error)
	GetToken(ctx context.Context, opts *bind.CallOpts, state TokenPoolState) (*models.SuiTransactionBlockResponse, error)
	GetSymbol(ctx context.Context, opts *bind.CallOpts, state TokenPoolState) (*models.SuiTransactionBlockResponse, error)
	GetCurrentInboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error)
	GetCurrentOutboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error)
	...
	CalculateReleaseOrMintAmount(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, sourcePoolData []byte, sourceAmount *big.Int) (*models.SuiTransactionBlockResponse, error)
...
type ITokenPoolDevInspect interface {
	Initialize(ctx context.Context, opts *bind.CallOpts, coinMetadataAddress string, localDecimals byte, symbol string, allowlist []string) (TokenPoolState, error)
	GetToken(ctx context.Context, opts *bind.CallOpts, state TokenPoolState) (string, error)
	GetSymbol(ctx context.Context, opts *bind.CallOpts, state TokenPoolState) (string, error)
	GetCurrentInboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (bind.Object, error)
	GetCurrentOutboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (bind.Object, error)
	...
	CalculateReleaseOrMintAmount(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, sourcePoolData []byte, sourceAmount *big.Int) (uint64, error)
...
type TokenPoolEncoder interface {
	Initialize(coinMetadataAddress string, localDecimals byte, symbol string, allowlist []string) (*bind.EncodedCall, error)
	...
	GetSymbol(state TokenPoolState) (*bind.EncodedCall, error)
	GetSymbolWithArgs(args ...any) (*bind.EncodedCall, error)
	GetCurrentInboundRateLimiterState(state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (*bind.EncodedCall, error)
	GetCurrentInboundRateLimiterStateWithArgs(args ...any) (*bind.EncodedCall, error)
	GetCurrentOutboundRateLimiterState(state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (*bind.EncodedCall, error)
	...
	CalculateReleaseOrMintAmount(state TokenPoolState, sourcePoolData []byte, sourceAmount *big.Int) (*bind.EncodedCall, error)
...
func NewTokenPool(packageID string, client sui.ISuiAPI) (ITokenPool, error) {
	contract, err := bind.NewBoundContract(packageID, "lock_release_token_pool", "token_pool", client)
	if err != nil {
		return nil, err
	}
...
type TokenPoolState struct {
	...
	Symbol             string      `move:"ascii::String"`
...
func init() {
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::TokenPoolState", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::TokenPoolState>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::RemoteChainConfig", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::RemoteChainConfig>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::LockedOrBurned", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::LockedOrBurned>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::ReleasedOrMinted", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::ReleasedOrMinted>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::RemotePoolAdded", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::RemotePoolAdded>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::RemotePoolRemoved", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::RemotePoolRemoved>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::ChainAdded", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::ChainAdded>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::ChainRemoved", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::ChainRemoved>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::LiquidityAdded", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::LiquidityAdded>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::LiquidityRemoved", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::LiquidityRemoved>", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::token_pool::RebalancerSet", func(data []byte) (interface{}, error) {
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::token_pool::RebalancerSet>", func(data []byte) (interface{}, error) {
...
func (c *TokenPoolContract) Initialize(ctx context.Context, opts *bind.CallOpts, coinMetadataAddress string, localDecimals byte, symbol string, allowlist []string) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.tokenPoolEncoder.Initialize(coinMetadataAddress, localDecimals, symbol, allowlist)
	if err != nil {
...
// GetSymbol executes the get_symbol Move function.
func (c *TokenPoolContract) GetSymbol(ctx context.Context, opts *bind.CallOpts, state TokenPoolState) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.tokenPoolEncoder.GetSymbol(state)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *TokenPoolContract) GetCurrentInboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.tokenPoolEncoder.GetCurrentInboundRateLimiterState(state, clock, remoteChainSelector)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *TokenPoolContract) GetCurrentOutboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.tokenPoolEncoder.GetCurrentOutboundRateLimiterState(state, clock, remoteChainSelector)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *TokenPoolContract) CalculateReleaseOrMintAmount(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, sourcePoolData []byte, sourceAmount *big.Int) (*models.SuiTransactionBlockResponse, error) {
...
func (d *TokenPoolDevInspect) Initialize(ctx context.Context, opts *bind.CallOpts, coinMetadataAddress string, localDecimals byte, symbol string, allowlist []string) (TokenPoolState, error) {
	encoded, err := d.contract.tokenPoolEncoder.Initialize(coinMetadataAddress, localDecimals, symbol, allowlist)
	if err != nil {
...
// GetSymbol executes the get_symbol Move function using DevInspect to get return values.
//
// Returns: ascii::String
func (d *TokenPoolDevInspect) GetSymbol(ctx context.Context, opts *bind.CallOpts, state TokenPoolState) (string, error) {
	encoded, err := d.contract.tokenPoolEncoder.GetSymbol(state)
	if err != nil {
		return "", fmt.Errorf("failed to encode function call: %w", err)
	}
	results, err := d.contract.Call(ctx, opts, encoded)
...
func (d *TokenPoolDevInspect) GetCurrentInboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (bind.Object, error) {
	encoded, err := d.contract.tokenPoolEncoder.GetCurrentInboundRateLimiterState(state, clock, remoteChainSelector)
	if err != nil {
...
//
// Returns: rate_limiter::TokenBucket
func (d *TokenPoolDevInspect) GetCurrentOutboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (bind.Object, error) {
	encoded, err := d.contract.tokenPoolEncoder.GetCurrentOutboundRateLimiterState(state, clock, remoteChainSelector)
	if err != nil {
		return bind.Object{}, fmt.Errorf("failed to encode function call: %w", err)
	}
	results, err := d.contract.Call(ctx, opts, encoded)
...
//
// Returns: u64
func (d *TokenPoolDevInspect) CalculateReleaseOrMintAmount(ctx context.Context, opts *bind.CallOpts, state TokenPoolState, sourcePoolData []byte, sourceAmount *big.Int) (uint64, error) {
...
func (c tokenPoolEncoder) Initialize(coinMetadataAddress string, localDecimals byte, symbol string, allowlist []string) (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	...
	return c.EncodeCallArgsWithGenerics("initialize", typeArgsList, typeParamsList, []string{
		...
		"lock_release_token_pool::token_pool::TokenPoolState",
	})
}
...
// GetSymbol encodes a call to the get_symbol Move function.
func (c tokenPoolEncoder) GetSymbol(state TokenPoolState) (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	typeParamsList := []string{}
	return c.EncodeCallArgsWithGenerics("get_symbol", typeArgsList, typeParamsList, []string{
		"&TokenPoolState",
	}, []any{
		state,
	}, []string{
...
// GetSymbolWithArgs encodes a call to the get_symbol Move function using arbitrary arguments.
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c tokenPoolEncoder) GetSymbolWithArgs(args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&TokenPoolState",
	}
	...
	typeArgsList := []string{}
	typeParamsList := []string{}
	return c.EncodeCallArgsWithGenerics("get_symbol", typeArgsList, typeParamsList, expectedParams, args, []string{
		"ascii::String",
	})
}

// GetCurrentInboundRateLimiterState encodes a call to the get_current_inbound_rate_limiter_state Move function.
func (c tokenPoolEncoder) GetCurrentInboundRateLimiterState(state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	typeParamsList := []string{}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c tokenPoolEncoder) GetCurrentInboundRateLimiterStateWithArgs(args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&TokenPoolState",
		"&Clock",
		"u64",
...
func (c tokenPoolEncoder) GetCurrentOutboundRateLimiterState(state TokenPoolState, clock bind.Object, remoteChainSelector uint64) (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	typeParamsList := []string{}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c tokenPoolEncoder) GetCurrentOutboundRateLimiterStateWithArgs(args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&TokenPoolState",
		"&Clock",
		"u64",
...
func (c tokenPoolEncoder) CalculateReleaseOrMintAmount(state TokenPoolState, sourcePoolData []byte, sourceAmount *big.Int) (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	typeParamsList := []string{}
