...
type ILockReleaseTokenPool interface {
	...
	ReleaseOrMint(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, receiverParams bind.Object, clock bind.Object, state bind.Object) (*models.SuiTransactionBlockResponse, error)
	...
	ProvideLiquidity(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, rebalancerCap bind.Object, c_ bind.Object) (*models.SuiTransactionBlockResponse, error)
	WithdrawLiquidity(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, rebalancerCap bind.Object, amount uint64) (*models.SuiTransactionBlockResponse, error)
...
type ILockReleaseTokenPoolDevInspect interface {
	...
	WithdrawLiquidity(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, rebalancerCap bind.Object, amount uint64) (any, error)
...
type LockReleaseTokenPoolEncoder interface {
	...
	Initialize(typeArgs []string, ownerCap bind.Object, ref bind.Object, coinMetadata bind.Object, treasuryCap bind.Object, tokenPoolAdministrator string, rebalancer string) (*bind.EncodedCall, error)
	...
	ReleaseOrMint(typeArgs []string, ref bind.Object, receiverParams bind.Object, clock bind.Object, state bind.Object) (*bind.EncodedCall, error)
	...
	ProvideLiquidity(typeArgs []string, state bind.Object, rebalancerCap bind.Object, c_ bind.Object) (*bind.EncodedCall, error)
	ProvideLiquidityWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error)
	WithdrawLiquidity(typeArgs []string, state bind.Object, rebalancerCap bind.Object, amount uint64) (*bind.EncodedCall, error)
	...
	McmsSetRebalancer(typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error)
...
type LockReleaseTokenPoolState struct {
	...
	RebalancerCapId bind.Object `move:"ID"`
	OwnableState    bind.Object `move:"OwnableState"`
}

type RebalancerCap struct {
	Id string `move:"sui::object::UID"`
}

type RebalancerSet struct {
	OldRebalancerCapId bind.Object `move:"ID"`
	NewRebalancerCapId bind.Object `move:"ID"`
}
...
type McmsCap struct {
	Id            string       `move:"sui::object::UID"`
	OwnerCap      bind.Object  `move:"OwnerCap"`
	RebalancerCap *bind.Object `move:"0x1::option::Option<RebalancerCap<T>>"`
}
...
func init() {
	...
	bind.RegisterStructDecoder("lock_release_token_pool::lock_release_token_pool::LockReleaseTokenPoolState", func(data []byte) (interface{}, error) {
		var result LockReleaseTokenPoolState
		_, err := mystenbcs.Unmarshal(data, &result)
		if err != nil {
			return nil, err
		}
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::lock_release_token_pool::LockReleaseTokenPoolState>", func(data []byte) (interface{}, error) {
		var results []LockReleaseTokenPoolState
		_, err := mystenbcs.Unmarshal(data, &results)
		if err != nil {
			return nil, err
		}
	...
	bind.RegisterStructDecoder("lock_release_token_pool::lock_release_token_pool::RebalancerCap", func(data []byte) (interface{}, error) {
		var result RebalancerCap
		_, err := mystenbcs.Unmarshal(data, &result)
		if err != nil {
			return nil, err
		}
	...
	// Register vector decoder for RebalancerCap
	bind.RegisterStructDecoder("vector<lock_release_token_pool::lock_release_token_pool::RebalancerCap>", func(data []byte) (interface{}, error) {
		var results []RebalancerCap
		_, err := mystenbcs.Unmarshal(data, &results)
		if err != nil {
			return nil, err
		}
	...
	bind.RegisterStructDecoder("lock_release_token_pool::lock_release_token_pool::RebalancerSet", func(data []byte) (interface{}, error) {
		var result RebalancerSet
		_, err := mystenbcs.Unmarshal(data, &result)
		if err != nil {
			return nil, err
		}
	...
	bind.RegisterStructDecoder("vector<lock_release_token_pool::lock_release_token_pool::RebalancerSet>", func(data []byte) (interface{}, error) {
		var results []RebalancerSet
		_, err := mystenbcs.Unmarshal(data, &results)
		if err != nil {
			return nil, err
		}
	...
	bind.RegisterStructDecoder("lock_release_token_pool::lock_release_token_pool::McmsCap", func(data []byte) (interface{}, error) {
		var result McmsCap
		_, err := mystenbcs.Unmarshal(data, &result)
		if err != nil {
			return nil, err
	...
	// Register vector decoder for McmsCap
	bind.RegisterStructDecoder("vector<lock_release_token_pool::lock_release_token_pool::McmsCap>", func(data []byte) (interface{}, error) {
		var results []McmsCap
		_, err := mystenbcs.Unmarshal(data, &results)
		if err != nil {
			return nil, err
...
func (c *LockReleaseTokenPoolContract) Initialize(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ownerCap bind.Object, ref bind.Object, coinMetadata bind.Object, treasuryCap bind.Object, tokenPoolAdministrator string, rebalancer string) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.Initialize(typeArgs, ownerCap, ref, coinMetadata, treasuryCap, tokenPoolAdministrator, rebalancer)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) SetPool(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, state bind.Object, ownerCap bind.Object, coinMetadataAddress string) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.SetPool(typeArgs, ref, state, ownerCap, coinMetadataAddress)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) GetTokenSymbol(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.GetTokenSymbol(typeArgs, state)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) LockOrBurn(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, tokenTransferParams bind.Object, c_ bind.Object, remoteChainSelector uint64, clock bind.Object, state bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.LockOrBurn(typeArgs, ref, tokenTransferParams, c_, remoteChainSelector, clock, state)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) ReleaseOrMint(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, receiverParams bind.Object, clock bind.Object, state bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.ReleaseOrMint(typeArgs, ref, receiverParams, clock, state)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) GetCurrentInboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, typeArgs []string, clock bind.Object, state bind.Object, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.GetCurrentInboundRateLimiterState(typeArgs, clock, state, remoteChainSelector)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) GetCurrentOutboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, typeArgs []string, clock bind.Object, state bind.Object, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.GetCurrentOutboundRateLimiterState(typeArgs, clock, state, remoteChainSelector)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) ProvideLiquidity(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, rebalancerCap bind.Object, c_ bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.ProvideLiquidity(typeArgs, state, rebalancerCap, c_)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) WithdrawLiquidity(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, rebalancerCap bind.Object, amount uint64) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.WithdrawLiquidity(typeArgs, state, rebalancerCap, amount)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
// McmsSetRebalancer executes the mcms_set_rebalancer Move function.
func (c *LockReleaseTokenPoolContract) McmsSetRebalancer(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.McmsSetRebalancer(typeArgs, state, registry, params)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) SetRebalancer(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, ownerCap bind.Object, rebalancer string) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.SetRebalancer(typeArgs, state, ownerCap, rebalancer)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
// DestroyRebalancerCap executes the destroy_rebalancer_cap Move function.
func (c *LockReleaseTokenPoolContract) DestroyRebalancerCap(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, rebalancerCap bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.DestroyRebalancerCap(typeArgs, state, rebalancerCap)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) McmsAcceptOwnership(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.McmsAcceptOwnership(typeArgs, state, registry, params)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) ExecuteOwnershipTransfer(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ownerCap bind.Object, state bind.Object, to string) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.ExecuteOwnershipTransfer(typeArgs, ownerCap, state, to)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) McmsSetAllowlistEnabled(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.McmsSetAllowlistEnabled(typeArgs, state, registry, params)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) McmsApplyAllowlistUpdates(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.McmsApplyAllowlistUpdates(typeArgs, state, registry, params)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) McmsTransferOwnership(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.McmsTransferOwnership(typeArgs, state, registry, params)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c *LockReleaseTokenPoolContract) McmsExecuteOwnershipTransfer(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, registry bind.Object, deployerState bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.lockReleaseTokenPoolEncoder.McmsExecuteOwnershipTransfer(typeArgs, state, registry, deployerState, params)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (d *LockReleaseTokenPoolDevInspect) GetTokenSymbol(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object) (string, error) {
	encoded, err := d.contract.lockReleaseTokenPoolEncoder.GetTokenSymbol(typeArgs, state)
	if err != nil {
		return "", fmt.Errorf("failed to encode function call: %w", err)
	}
	results, err := d.contract.Call(ctx, opts, encoded)
...
func (d *LockReleaseTokenPoolDevInspect) GetCurrentInboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, typeArgs []string, clock bind.Object, state bind.Object, remoteChainSelector uint64) (bind.Object, error) {
	encoded, err := d.contract.lockReleaseTokenPoolEncoder.GetCurrentInboundRateLimiterState(typeArgs, clock, state, remoteChainSelector)
	if err != nil {
...
//
// Returns: rate_limiter::TokenBucket
func (d *LockReleaseTokenPoolDevInspect) GetCurrentOutboundRateLimiterState(ctx context.Context, opts *bind.CallOpts, typeArgs []string, clock bind.Object, state bind.Object, remoteChainSelector uint64) (bind.Object, error) {
	encoded, err := d.contract.lockReleaseTokenPoolEncoder.GetCurrentOutboundRateLimiterState(typeArgs, clock, state, remoteChainSelector)
	if err != nil {
		return bind.Object{}, fmt.Errorf("failed to encode function call: %w", err)
	}
	results, err := d.contract.Call(ctx, opts, encoded)
...
//
// Returns: Coin<T>
func (d *LockReleaseTokenPoolDevInspect) WithdrawLiquidity(ctx context.Context, opts *bind.CallOpts, typeArgs []string, state bind.Object, rebalancerCap bind.Object, amount uint64) (any, error) {
	encoded, err := d.contract.lockReleaseTokenPoolEncoder.WithdrawLiquidity(typeArgs, state, rebalancerCap, amount)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
	results, err := d.contract.Call(ctx, opts, encoded)
...
func (c lockReleaseTokenPoolEncoder) Initialize(typeArgs []string, ownerCap bind.Object, ref bind.Object, coinMetadata bind.Object, treasuryCap bind.Object, tokenPoolAdministrator string, rebalancer string) (*bind.EncodedCall, error) {
...
func (c lockReleaseTokenPoolEncoder) SetPool(typeArgs []string, ref bind.Object, state bind.Object, ownerCap bind.Object, coinMetadataAddress string) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c lockReleaseTokenPoolEncoder) GetTokenSymbol(typeArgs []string, state bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) GetTokenSymbolWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&LockReleaseTokenPoolState<T>",
	}
...
func (c lockReleaseTokenPoolEncoder) LockOrBurn(typeArgs []string, ref bind.Object, tokenTransferParams bind.Object, c_ bind.Object, remoteChainSelector uint64, clock bind.Object, state bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c lockReleaseTokenPoolEncoder) ReleaseOrMint(typeArgs []string, ref bind.Object, receiverParams bind.Object, clock bind.Object, state bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c lockReleaseTokenPoolEncoder) GetCurrentInboundRateLimiterState(typeArgs []string, clock bind.Object, state bind.Object, remoteChainSelector uint64) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) GetCurrentInboundRateLimiterStateWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&Clock",
		"&LockReleaseTokenPoolState<T>",
		"u64",
...
func (c lockReleaseTokenPoolEncoder) GetCurrentOutboundRateLimiterState(typeArgs []string, clock bind.Object, state bind.Object, remoteChainSelector uint64) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) GetCurrentOutboundRateLimiterStateWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&Clock",
		"&LockReleaseTokenPoolState<T>",
		"u64",
...
func (c lockReleaseTokenPoolEncoder) ProvideLiquidity(typeArgs []string, state bind.Object, rebalancerCap bind.Object, c_ bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c lockReleaseTokenPoolEncoder) WithdrawLiquidity(typeArgs []string, state bind.Object, rebalancerCap bind.Object, amount uint64) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// McmsSetRebalancer encodes a call to the mcms_set_rebalancer Move function.
func (c lockReleaseTokenPoolEncoder) McmsSetRebalancer(typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
	return c.EncodeCallArgsWithGenerics("mcms_set_rebalancer", typeArgsList, typeParamsList, []string{
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
...
// McmsSetRebalancerWithArgs encodes a call to the mcms_set_rebalancer Move function using arbitrary arguments.
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsSetRebalancerWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
		"ExecutingCallbackParams",
	...
	return c.EncodeCallArgsWithGenerics("mcms_set_rebalancer", typeArgsList, typeParamsList, expectedParams, args, nil)
}

// SetRebalancer encodes a call to the set_rebalancer Move function.
func (c lockReleaseTokenPoolEncoder) SetRebalancer(typeArgs []string, state bind.Object, ownerCap bind.Object, rebalancer string) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c lockReleaseTokenPoolEncoder) DestroyRebalancerCap(typeArgs []string, state bind.Object, rebalancerCap bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
	return c.EncodeCallArgsWithGenerics("destroy_rebalancer_cap", typeArgsList, typeParamsList, []string{
		"&mut LockReleaseTokenPoolState<T>",
		"RebalancerCap<T>",
	}, []any{
		state,
...
// DestroyRebalancerCapWithArgs encodes a call to the destroy_rebalancer_cap Move function using arbitrary arguments.
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) DestroyRebalancerCapWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut LockReleaseTokenPoolState<T>",
		"RebalancerCap<T>",
	}
	...
	return c.EncodeCallArgsWithGenerics("destroy_rebalancer_cap", typeArgsList, typeParamsList, expectedParams, args, nil)
}
...
func (c lockReleaseTokenPoolEncoder) McmsAcceptOwnership(typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsAcceptOwnershipWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
		"ExecutingCallbackParams",
...
func (c lockReleaseTokenPoolEncoder) ExecuteOwnershipTransfer(typeArgs []string, ownerCap bind.Object, state bind.Object, to string) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
func (c lockReleaseTokenPoolEncoder) McmsSetAllowlistEnabled(typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsSetAllowlistEnabledWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
		"ExecutingCallbackParams",
...
func (c lockReleaseTokenPoolEncoder) McmsApplyAllowlistUpdates(typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsApplyAllowlistUpdatesWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
		"ExecutingCallbackParams",
...
func (c lockReleaseTokenPoolEncoder) McmsApplyChainUpdates(typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsApplyChainUpdatesWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
		"ExecutingCallbackParams",
...
func (c lockReleaseTokenPoolEncoder) McmsSetPool(typeArgs []string, ref bind.Object, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsSetPoolWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut CCIPObjectRef",
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
...
func (c lockReleaseTokenPoolEncoder) McmsTransferOwnership(typeArgs []string, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsTransferOwnershipWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
		"ExecutingCallbackParams",
...
func (c lockReleaseTokenPoolEncoder) McmsExecuteOwnershipTransfer(typeArgs []string, state bind.Object, registry bind.Object, deployerState bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsExecuteOwnershipTransferWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut LockReleaseTokenPoolState<T>",
		"&mut Registry",
		"&mut DeployerState",
...
func (c lockReleaseTokenPoolEncoder) McmsDestroyTokenPool(typeArgs []string, ref bind.Object, state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
	}
...
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c lockReleaseTokenPoolEncoder) McmsDestroyTokenPoolWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut CCIPObjectRef",
		"LockReleaseTokenPoolState<T>",
		"&mut Registry",
