...
type IOnramp interface {
	...
	GetFqTypeAndVersion(ctx context.Context, opts *bind.CallOpts) (*models.SuiTransactionBlockResponse, error)
...
type IOnrampDevInspect interface {
	...
	GetFqTypeAndVersion(ctx context.Context, opts *bind.CallOpts) (string, error)
...
type OnrampEncoder interface {
	...
	GetFqTypeAndVersion() (*bind.EncodedCall, error)
	GetFqTypeAndVersionWithArgs(args ...any) (*bind.EncodedCall, error)
...
// GetFqTypeAndVersion executes the get_fq_type_and_version Move function.
func (c *OnrampContract) GetFqTypeAndVersion(ctx context.Context, opts *bind.CallOpts) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.onrampEncoder.GetFqTypeAndVersion()
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
// GetFqTypeAndVersion executes the get_fq_type_and_version Move function using DevInspect to get return values.
//
// Returns: 0x1::string::String
func (d *OnrampDevInspect) GetFqTypeAndVersion(ctx context.Context, opts *bind.CallOpts) (string, error) {
	encoded, err := d.contract.onrampEncoder.GetFqTypeAndVersion()
	if err != nil {
		return "", fmt.Errorf("failed to encode function call: %w", err)
	}
	results, err := d.contract.Call(ctx, opts, encoded)
...
// GetFqTypeAndVersion encodes a call to the get_fq_type_and_version Move function.
func (c onrampEncoder) GetFqTypeAndVersion() (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	typeParamsList := []string{}
	return c.EncodeCallArgsWithGenerics("get_fq_type_and_version", typeArgsList, typeParamsList, []string{}, []any{}, []string{
		"0x1::string::String",
	})
}

// GetFqTypeAndVersionWithArgs encodes a call to the get_fq_type_and_version Move function using arbitrary arguments.
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c onrampEncoder) GetFqTypeAndVersionWithArgs(args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{}
	...
	typeArgsList := []string{}
	typeParamsList := []string{}
	return c.EncodeCallArgsWithGenerics("get_fq_type_and_version", typeArgsList, typeParamsList, expectedParams, args, []string{
		"0x1::string::String",
	})
}
