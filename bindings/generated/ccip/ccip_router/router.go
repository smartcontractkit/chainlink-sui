...
const FunctionInfo = `[{"package":"ccip_router","module":"router","name":"accept_ownership","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"accept_ownership_from_object","parameters":[{"name":"state","type":"bind.Object"},{"name":"from","type":"string"}]},{"package":"ccip_router","module":"router","name":"execute_ownership_transfer","parameters":[{"name":"owner_cap","type":"bind.Object"},{"name":"ownable_state","type":"bind.Object"},{"name":"to","type":"string"}]},{"package":"ccip_router","module":"router","name":"execute_ownership_transfer_to_mcms","parameters":[{"name":"owner_cap","type":"bind.Object"},{"name":"state","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"to","type":"string"}]},{"package":"ccip_router","module":"router","name":"get_on_ramp_address","parameters":[{"name":"info","type":"OnRampInfo"}]},{"package":"ccip_router","module":"router","name":"get_on_ramp_info","parameters":[{"name":"router","type":"bind.Object"},{"name":"dest_chain_selector","type":"uint64"}]},{"package":"ccip_router","module":"router","name":"get_on_ramp_infos","parameters":[{"name":"router","type":"bind.Object"},{"name":"dest_chain_selectors","type":"[]uint64"}]},{"package":"ccip_router","module":"router","name":"get_on_ramp_version","parameters":[{"name":"info","type":"OnRampInfo"}]},{"package":"ccip_router","module":"router","name":"has_pending_transfer","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"is_chain_supported","parameters":[{"name":"router","type":"bind.Object"},{"name":"dest_chain_selector","type":"uint64"}]},{"package":"ccip_router","module":"router","name":"mcms_accept_ownership","parameters":[{"name":"state","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"mcms_execute_ownership_transfer","parameters":[{"name":"state","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"mcms_register_upgrade_cap","parameters":[{"name":"upgrade_cap","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"state","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"mcms_set_on_ramp_infos","parameters":[{"name":"state","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"mcms_transfer_ownership","parameters":[{"name":"state","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"owner","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"pending_transfer_accepted","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"pending_transfer_from","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"pending_transfer_to","parameters":[{"name":"state","type":"bind.Object"}]},{"package":"ccip_router","module":"router","name":"set_on_ramp_infos","parameters":[{"name":"owner_cap","type":"bind.Object"},{"name":"router","type":"bind.Object"},{"name":"dest_chain_selectors","type":"[]uint64"},{"name":"on_ramp_addresses","type":"[]string"},{"name":"on_ramp_versions","type":"[][]byte"}]},{"package":"ccip_router","module":"router","name":"transfer_ownership","parameters":[{"name":"state","type":"bind.Object"},{"name":"owner_cap","type":"bind.Object"},{"name":"new_owner","type":"string"}]},{"package":"ccip_router","module":"router","name":"type_and_version","parameters":null}]`
...
func (c routerEncoder) McmsExecuteOwnershipTransfer(state bind.Object, registry bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	typeParamsList := []string{}
