...
func NewOnramp(packageID string, chainClient client.BindingsClient) (IOnramp, error) {
	contract, err := bind.NewBoundContract(packageID, "ccip_onramp", "onramp", chainClient)
	if err != nil {
		return nil, err
	}
