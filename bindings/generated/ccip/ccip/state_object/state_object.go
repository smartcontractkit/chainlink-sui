...
type IStateObject interface {
	...
	McmsAcceptOwnership(ctx context.Context, opts *bind.CallOpts, ref bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error)
...
type StateObjectEncoder interface {
	...
	McmsAcceptOwnership(ref bind.Object, params bind.Object) (*bind.EncodedCall, error)
...
func (c *StateObjectContract) McmsAcceptOwnership(ctx context.Context, opts *bind.CallOpts, ref bind.Object, params bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.stateObjectEncoder.McmsAcceptOwnership(ref, params)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
func (c stateObjectEncoder) McmsAcceptOwnership(ref bind.Object, params bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	typeParamsList := []string{}
