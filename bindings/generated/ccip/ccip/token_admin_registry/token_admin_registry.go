...
type ITokenAdminRegistry interface {
	...
	RegisterPoolWithRegulatedCoin(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, param bind.Object, coinMetadata bind.Object, initialAdministrator string, lockOrBurnParams []string, releaseOrMintParams []string, publisherWrapper bind.Object, proof bind.Object) (*models.SuiTransactionBlockResponse, error)
	RegisterPoolWithCurrency(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, param bind.Object, currency bind.Object, initialAdministrator string, lockOrBurnParams []string, releaseOrMintParams []string, publisherWrapper bind.Object, proof bind.Object) (*models.SuiTransactionBlockResponse, error)
...
type TokenAdminRegistryEncoder interface {
	...
	RegisterPoolWithRegulatedCoin(typeArgs []string, ref bind.Object, param bind.Object, coinMetadata bind.Object, initialAdministrator string, lockOrBurnParams []string, releaseOrMintParams []string, publisherWrapper bind.Object, proof bind.Object) (*bind.EncodedCall, error)
	RegisterPoolWithRegulatedCoinWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error)
	RegisterPoolWithCurrency(typeArgs []string, ref bind.Object, param bind.Object, currency bind.Object, initialAdministrator string, lockOrBurnParams []string, releaseOrMintParams []string, publisherWrapper bind.Object, proof bind.Object) (*bind.EncodedCall, error)
	RegisterPoolWithCurrencyWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error)
...
// RegisterPoolWithRegulatedCoin executes the register_pool_with_regulated_coin Move function.
func (c *TokenAdminRegistryContract) RegisterPoolWithRegulatedCoin(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, param bind.Object, coinMetadata bind.Object, initialAdministrator string, lockOrBurnParams []string, releaseOrMintParams []string, publisherWrapper bind.Object, proof bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.tokenAdminRegistryEncoder.RegisterPoolWithRegulatedCoin(typeArgs, ref, param, coinMetadata, initialAdministrator, lockOrBurnParams, releaseOrMintParams, publisherWrapper, proof)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
// RegisterPoolWithCurrency executes the register_pool_with_currency Move function.
func (c *TokenAdminRegistryContract) RegisterPoolWithCurrency(ctx context.Context, opts *bind.CallOpts, typeArgs []string, ref bind.Object, param bind.Object, currency bind.Object, initialAdministrator string, lockOrBurnParams []string, releaseOrMintParams []string, publisherWrapper bind.Object, proof bind.Object) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.tokenAdminRegistryEncoder.RegisterPoolWithCurrency(typeArgs, ref, param, currency, initialAdministrator, lockOrBurnParams, releaseOrMintParams, publisherWrapper, proof)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
// RegisterPoolWithRegulatedCoin encodes a call to the register_pool_with_regulated_coin Move function.
func (c tokenAdminRegistryEncoder) RegisterPoolWithRegulatedCoin(typeArgs []string, ref bind.Object, param bind.Object, coinMetadata bind.Object, initialAdministrator string, lockOrBurnParams []string, releaseOrMintParams []string, publisherWrapper bind.Object, proof bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
		"TypeProof",
	}
	return c.EncodeCallArgsWithGenerics("register_pool_with_regulated_coin", typeArgsList, typeParamsList, []string{
		"&mut CCIPObjectRef",
		"&TreasuryCap<T>",
...
// RegisterPoolWithRegulatedCoinWithArgs encodes a call to the register_pool_with_regulated_coin Move function using arbitrary arguments.
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c tokenAdminRegistryEncoder) RegisterPoolWithRegulatedCoinWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut CCIPObjectRef",
		"&TreasuryCap<T>",
		"&RegulatedCoinMetadata<T>",
	...
	return c.EncodeCallArgsWithGenerics("register_pool_with_regulated_coin", typeArgsList, typeParamsList, expectedParams, args, nil)
}

// RegisterPoolWithCurrency encodes a call to the register_pool_with_currency Move function.
func (c tokenAdminRegistryEncoder) RegisterPoolWithCurrency(typeArgs []string, ref bind.Object, param bind.Object, currency bind.Object, initialAdministrator string, lockOrBurnParams []string, releaseOrMintParams []string, publisherWrapper bind.Object, proof bind.Object) (*bind.EncodedCall, error) {
	typeArgsList := typeArgs
	typeParamsList := []string{
		"T",
		"TypeProof",
	}
	return c.EncodeCallArgsWithGenerics("register_pool_with_currency", typeArgsList, typeParamsList, []string{
		"&mut CCIPObjectRef",
		"&TreasuryCap<T>",
		"&Currency<T>",
		"address",
...
// RegisterPoolWithCurrencyWithArgs encodes a call to the register_pool_with_currency Move function using arbitrary arguments.
// This method allows passing both regular values and transaction.Argument values for PTB chaining.
func (c tokenAdminRegistryEncoder) RegisterPoolWithCurrencyWithArgs(typeArgs []string, args ...any) (*bind.EncodedCall, error) {
	expectedParams := []string{
		"&mut CCIPObjectRef",
		"&TreasuryCap<T>",
		"&Currency<T>",
	...
	return c.EncodeCallArgsWithGenerics("register_pool_with_currency", typeArgsList, typeParamsList, expectedParams, args, nil)
}
