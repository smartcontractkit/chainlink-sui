...
type IFeeQuoter interface {
	...
	GetTokenReceiver(ctx context.Context, opts *bind.CallOpts, ref bind.Object, destChainSelector uint64, extraArgs []byte, defaultTokenReceiver []byte) (*models.SuiTransactionBlockResponse, error)
...
type IFeeQuoterDevInspect interface {
	...
	GetTokenReceiver(ctx context.Context, opts *bind.CallOpts, ref bind.Object, destChainSelector uint64, extraArgs []byte, defaultTokenReceiver []byte) ([]byte, error)
...
type FeeQuoterEncoder interface {
	...
	GetTokenReceiver(ref bind.Object, destChainSelector uint64, extraArgs []byte, defaultTokenReceiver []byte) (*bind.EncodedCall, error)
...
func (c *FeeQuoterContract) GetTokenReceiver(ctx context.Context, opts *bind.CallOpts, ref bind.Object, destChainSelector uint64, extraArgs []byte, defaultTokenReceiver []byte) (*models.SuiTransactionBlockResponse, error) {
	encoded, err := c.feeQuoterEncoder.GetTokenReceiver(ref, destChainSelector, extraArgs, defaultTokenReceiver)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
...
//
// Returns: vector<u8>
func (d *FeeQuoterDevInspect) GetTokenReceiver(ctx context.Context, opts *bind.CallOpts, ref bind.Object, destChainSelector uint64, extraArgs []byte, defaultTokenReceiver []byte) ([]byte, error) {
	encoded, err := d.contract.feeQuoterEncoder.GetTokenReceiver(ref, destChainSelector, extraArgs, defaultTokenReceiver)
	if err != nil {
		return nil, fmt.Errorf("failed to encode function call: %w", err)
	}
	results, err := d.contract.Call(ctx, opts, encoded)
...
func (c feeQuoterEncoder) GetTokenReceiver(ref bind.Object, destChainSelector uint64, extraArgs []byte, defaultTokenReceiver []byte) (*bind.EncodedCall, error) {
	typeArgsList := []string{}
	typeParamsList := []string{}
