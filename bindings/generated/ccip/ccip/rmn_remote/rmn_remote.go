...
const FunctionInfo = `[{"package":"ccip","module":"rmn_remote","name":"curse","parameters":[{"name":"ref","type":"bind.Object"},{"name":"owner_cap","type":"bind.Object"},{"name":"subject","type":"[]byte"}]},{"package":"ccip","module":"rmn_remote","name":"curse_multiple","parameters":[{"name":"ref","type":"bind.Object"},{"name":"_","type":"bind.Object"},{"name":"subjects","type":"[][]byte"}]},{"package":"ccip","module":"rmn_remote","name":"get_arm","parameters":null},{"package":"ccip","module":"rmn_remote","name":"get_cursed_subjects","parameters":[{"name":"ref","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"get_local_chain_selector","parameters":[{"name":"ref","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"get_report_digest_header","parameters":null},{"package":"ccip","module":"rmn_remote","name":"get_versioned_config","parameters":[{"name":"ref","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"initialize","parameters":[{"name":"ref","type":"bind.Object"},{"name":"owner_cap","type":"bind.Object"},{"name":"local_chain_selector","type":"uint64"}]},{"package":"ccip","module":"rmn_remote","name":"is_cursed","parameters":[{"name":"ref","type":"bind.Object"},{"name":"subject","type":"[]byte"}]},{"package":"ccip","module":"rmn_remote","name":"is_cursed_global","parameters":[{"name":"ref","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"is_cursed_u128","parameters":[{"name":"ref","type":"bind.Object"},{"name":"subject_value","type":"*big.Int"}]},{"package":"ccip","module":"rmn_remote","name":"mcms_curse","parameters":[{"name":"ref","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"mcms_curse_multiple","parameters":[{"name":"ref","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"mcms_set_config","parameters":[{"name":"ref","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"mcms_uncurse","parameters":[{"name":"ref","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"mcms_uncurse_multiple","parameters":[{"name":"ref","type":"bind.Object"},{"name":"registry","type":"bind.Object"},{"name":"params","type":"bind.Object"}]},{"package":"ccip","module":"rmn_remote","name":"set_config","parameters":[{"name":"ref","type":"bind.Object"},{"name":"_","type":"bind.Object"},{"name":"rmn_home_contract_config_digest","type":"[]byte"},{"name":"signer_onchain_public_keys","type":"[][]byte"},{"name":"node_indexes","type":"[]uint64"},{"name":"f_sign","type":"uint64"}]},{"package":"ccip","module":"rmn_remote","name":"type_and_version","parameters":null},{"package":"ccip","module":"rmn_remote","name":"uncurse","parameters":[{"name":"ref","type":"bind.Object"},{"name":"owner_cap","type":"bind.Object"},{"name":"subject","type":"[]byte"}]},{"package":"ccip","module":"rmn_remote","name":"uncurse_multiple","parameters":[{"name":"ref","type":"bind.Object"},{"name":"_","type":"bind.Object"},{"name":"subjects","type":"[][]byte"}]},{"package":"ccip","module":"rmn_remote","name":"verify","parameters":[{"name":"ref","type":"bind.Object"},{"name":"off_ramp_state_address","type":"string"},{"name":"merkle_root_source_chain_selectors","type":"[]uint64"},{"name":"merkle_root_on_ramp_addresses","type":"[][]byte"},{"name":"merkle_root_min_seq_nrs","type":"[]uint64"},{"name":"merkle_root_max_seq_nrs","type":"[]uint64"},{"name":"merkle_root_values","type":"[][]byte"},{"name":"signatures","type":"[][]byte"}]}]`
