...
) (USDCTokenPool, *models.SuiTransactionBlockResponse, error) {

	artifact, err := bind.CompilePackage(contracts.USDCTokenPool, map[string]string{
		"ccip":                         ccipPackageId,
		"ccip_token_pool":              ccipTokenPoolPackageId,
		"usdc_token_pool":              "0x0",
		"usdc_coin_metadata_object_id": usdcCoinMetadataObjectId,
		"token_messenger_minter":       tokenMessengerMinterPackageId,
		"token_messenger_minter_state": tokenMessengerMinterStateObjectId,
		"message_transmitter":          messageTransmitterPackageId,
