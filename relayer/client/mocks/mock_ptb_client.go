...
// Source: relayer/client/grpc_client.go
...
func (m *MockSuiPTBClient) BlockByDigest(ctx context.Context, txDigest string) (*v2.Checkpoint, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSuiPTBClientMockRecorder) EstimateGas(ctx, tx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimateGas", reflect.TypeOf((*MockSuiPTBClient)(nil).EstimateGas), ctx, tx)
}

// FinishPTBAndSend mocks base method.
func (m *MockSuiPTBClient) FinishPTBAndSend(ctx context.Context, txnSigner *signer.Signer, tx *transaction.Transaction, requestType client.TransactionRequestType) (*v2.ExecuteTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FinishPTBAndSend", ctx, txnSigner, tx, requestType)
	ret0, _ := ret[0].(*v2.ExecuteTransactionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSuiPTBClient) GetBlockById(ctx context.Context, checkpointDigest string) (*v2.Checkpoint, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBlockById", ctx, checkpointDigest)
	ret0, _ := ret[0].(*v2.Checkpoint)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSuiPTBClientMockRecorder) GetBlockById(ctx, checkpointDigest interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBlockById", reflect.TypeOf((*MockSuiPTBClient)(nil).GetBlockById), ctx, checkpointDigest)
}
...
func (m *MockSuiPTBClient) GetCCIPPackageID(ctx context.Context, offRampPackageID string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCCIPPackageID", ctx, offRampPackageID)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSuiPTBClientMockRecorder) GetCCIPPackageID(ctx, offRampPackageID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCCIPPackageID", reflect.TypeOf((*MockSuiPTBClient)(nil).GetCCIPPackageID), ctx, offRampPackageID)
}
...
func (m *MockSuiPTBClient) GetCoinsByAddress(ctx context.Context, address string) ([]*v2.Object, error) {
	m.ctrl.T.Helper()
...
func (m *MockSuiPTBClient) GetLatestEpoch(ctx context.Context) (*v2.Epoch, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLatestEpoch", ctx)
	ret0, _ := ret[0].(*v2.Epoch)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLatestEpoch indicates an expected call of GetLatestEpoch.
func (mr *MockSuiPTBClientMockRecorder) GetLatestEpoch(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSuiPTBClientMockRecorder) GetNormalizedModule(ctx, packageId, moduleId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSuiPTBClientMockRecorder) GetParentObjectID(ctx, packageID, moduleID, pointerObjectName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSuiPTBClientMockRecorder) GetReferenceGasPrice(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockSuiPTBClient) GetSUIBalance(ctx context.Context, address string) (*v2.Balance, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSUIBalance", ctx, address)
	ret0, _ := ret[0].(*v2.Balance)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSuiPTBClientMockRecorder) LoadModulePackageIds(ctx, packageId, module interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockSuiPTBClient) QueryCoinsByAddress(ctx context.Context, address, coinType string) ([]*v2.Object, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSuiPTBClientMockRecorder) QueryCoinsByAddress(ctx, address, coinType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockSuiPTBClient) QueryTransactions(ctx context.Context, fromAddress string, cursor *v2.Checkpoint, limit *uint64) ([]*v2.ExecutedTransaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryTransactions", ctx, fromAddress, cursor, limit)
	ret0, _ := ret[0].([]*v2.ExecutedTransaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSuiPTBClient) ReadFilterOwnedObjectIds(ctx context.Context, ownerAddress, structType string, cursor []byte) ([]*v2.Object, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSuiPTBClientMockRecorder) ReadFilterOwnedObjectIds(ctx, ownerAddress, structType, cursor interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockSuiPTBClient) ReadFunction(ctx context.Context, packageId, module, function string, args []any, argTypes, typeArgs []string) ([]any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadFunction", ctx, packageId, module, function, args, argTypes, typeArgs)
	ret0, _ := ret[0].([]any)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSuiPTBClientMockRecorder) ReadFunction(ctx, packageId, module, function, args, argTypes, typeArgs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadFunction", reflect.TypeOf((*MockSuiPTBClient)(nil).ReadFunction), ctx, packageId, module, function, args, argTypes, typeArgs)
}

// ReadObjectId mocks base method.
func (m *MockSuiPTBClient) ReadObjectId(ctx context.Context, objectId string) (*v2.Object, error) {
	m.ctrl.T.Helper()
...
func (m *MockSuiPTBClient) SendTransaction(ctx context.Context, execRequest *v2.ExecuteTransactionRequest) (*v2.ExecuteTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendTransaction", ctx, execRequest)
	ret0, _ := ret[0].(*v2.ExecuteTransactionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSuiPTBClientMockRecorder) SendTransaction(ctx, execRequest interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendTransaction", reflect.TypeOf((*MockSuiPTBClient)(nil).SendTransaction), ctx, execRequest)
}
...
func (m *MockSuiPTBClient) SignAndSendTransaction(ctx context.Context, txBytesRaw string, signerPublicKey []byte) (*v2.ExecuteTransactionResponse, error) {
	m.ctrl.T.Helper()
