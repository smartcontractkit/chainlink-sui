...
// TODO: Use common pkg once the generic balance monitor is included there.
...
func (m *genericBalanceMonitor) updateBalances(ctx context.Context) {
	...
	for _, pk := range keys {
		...
		balance, err := reader.GetAccountBalance(ctx, accAddr)
		if err != nil {
