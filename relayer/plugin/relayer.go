...
func NewRelayer(cfg *config.TOMLConfig, lggr logger.Logger, keystore core.Keystore, db sqlutil.DataSource) (*SuiRelayer, error) {
	...
	loggerInstance.Info("TICKER VALUES1 TXINDEXER: ", *cfg.TransactionsIndexer.PollingIntervalSecs)
	loggerInstance.Info("TICKER VALUES2 TXINDEXER: ", *cfg.TransactionsIndexer.PollingIntervalSecs)

	loggerInstance.Info("TICKER VALUES3 EVENTSINDEXER: ", *cfg.EventsIndexer.PollingIntervalSecs)
	loggerInstance.Info("TICKER VALUES4 EVENTSINDEXER: ", *cfg.EventsIndexer.PollingIntervalSecs)
