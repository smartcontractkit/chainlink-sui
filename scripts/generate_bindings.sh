...
go run bindgen/main.go --moveConfig ./contracts/ccip/ccip_malicious_token_pool --input ./contracts/ccip/ccip_malicious_token_pool/sources/burn_mint_token_pool.move --output ./bindings/generated/ccip/ccip_malicious_token_pool/burn_mint_token_pool
