...
func TestLoadOnchainStatesui(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, tt.want[9762610643973837292], got[9762610643973837292], "unexpected chain state")
		})
	}
}
...
func getExpectedSuiChainState() CCIPChainState {
	return CCIPChainState{
		...
		CCIPBurnMintTokenPool:        "0x70f10215a219a1f2e30f746e68c1e4f2b39f593d83a1980c7cf4e4738591a7e5",
		CCIPBurnMintTokenPoolState:   "0x2d5b1f5a1e7b4049694e425f24b46e227eaf234ca362719394ebd0ae71790fc2",
		CCIPBurnMintTokenPoolOwnerId: "0x78dde1c270c6edf64e586850b04cba3701d259441f4390e3bc4490407a9ecc86",
	}
}
