...
func TestTransferOwnershipTokenPool_VerifyPreconditions(t *testing.T) {
	t.Parallel()

	cs := TransferOwnershipTokenPool{}

	// Missing chainSelector.
	err := cs.VerifyPreconditions(cldf.Environment{}, TransferOwnershipTokenPoolConfig{
