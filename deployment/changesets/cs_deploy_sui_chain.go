...
func (d DeploySuiChain) Apply(e cldf.Environment, config DeploySuiChainConfig) (cldf.ChangesetOutput, error) {
	...
	fmt.Println("ONRAMP INITIALIZE CONFIGS: ", ccipOnRampSeqInput.OnRampInitializeInput.DestChainEnabled)
	fmt.Println("ONRAMP APPLYDESTCHAINCONFIG CONFIGS: ", ccipOnRampSeqInput.ApplyDestChainConfigureOnRampInput)
