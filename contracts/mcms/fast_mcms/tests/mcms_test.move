...
// Generated by scripts/gen-fast-mcms-test-vectors (go run . -extract-fast)
...
const SIGNATURES: vector<vector<u8>> = vector[
    x"ce3a5c747eb11f87161819f5f6830c9771a6318feeeb6bfd55cbce836356102d00a0c09939ec209c95c09fe80d65c1ebbd434162dc4a465cfe46f3750df523fe1b",
    x"d44b3ddddcb6fc5088cff99725975f100b05e61e123d93cc386adbb135384ad170f719f95f83815155c54fe0c7b021c8e1c10db7791bf156af21699608298b031b",
];
...
fun test_timelock_dispatch_to_deployer() {
    ...
    let mcms_package = mcms_registry::get_multisig_address();
    let upgrade_cap = package::test_publish(
        TEST_UPGRADE_CAP_PACKAGE.to_id(),
        env.scenario.ctx(),
    );
    {
