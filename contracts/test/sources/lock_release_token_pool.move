// ================================================================
//          THIS IS A TEST CONTRACT FOR THE LOCK RELEASE TOKEN POOL
// ================================================================
...
public fun create_test_rebalancer_addresses(): vector<address> {
    vector[@0x4, @0x5, @0x6, @0x7]
}

/// Create test token addresses
public fun create_test_token_addresses(): vector<address> {
    vector[@0x8, @0x9, @0xa, @0xb]
}
...
/// Create test liquidity provider addresses
public fun create_test_provider_addresses(): vector<address> {
    vector[@0xc, @0xd, @0xe, @0xf]
}
