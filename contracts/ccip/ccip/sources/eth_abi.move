...
module ccip::eth_abi {
    ...
    // TODO: verify if we can use macro here
    // TODO: verify if decode_vector can be supported. skip for now because Sui Move does not allow passing functions as arguments
