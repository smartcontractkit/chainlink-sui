...
// Test addresses
const EVM_RECEIVER_ADDRESS: vector<u8> =
    x"000000000000000000000000f4030086522a5beea4988f8ca5b36dbc97bee88c";
const SVM_RECEIVER_ADDRESS: vector<u8> =
    x"1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef";
const SVM_TOKEN_RECEIVER: vector<u8> =
    x"1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef";
...
public fun test_apply_allowlist_updates() {
    ...
    onramp::apply_allowlist_updates(
        ...
        vector[vector[ALLOWED_SENDER_1, ALLOWED_SENDER_2], vector[ALLOWED_SENDER_3]], // dest_chain_add_allowed_senders
        vector[vector[], vector[]], // dest_chain_remove_allowed_senders
        env.scenario.ctx(),
    );
    ...
    onramp::apply_allowlist_updates(
        ...
        vector[DEST_CHAIN_SELECTOR_1, DEST_CHAIN_SELECTOR_2], // dest_chain_selectors
        vector[true, false], // dest_chain_allowlist_enabled
        vector[vector[], vector[]], // dest_chain_add_allowed_senders
        vector[vector[ALLOWED_SENDER_2], vector[]], // dest_chain_remove_allowed_senders
        env.scenario.ctx(),
    );
...
public fun test_set_dynamic_config() {
    ...
    let (updated_fee_aggregator, updated_allowlist_admin) = onramp::get_dynamic_config_fields(
        updated_config,
    );
...
public fun test_get_fee_success() {
    ...
    configure_fee_quoter_dest_chain(
        &mut ref,
        &ccip_owner_cap,
        DEST_CHAIN_SELECTOR_1,
