...
module ccip_offramp::offramp {
    ...
    fun after_ocr3_config_set(
        ...
        if (ocr_plugin_type == ocr3_base::ocr_plugin_type_commit()) {
            assert!(
                is_signature_verification_enabled,
                ESignatureVerificationRequiredInCommitPlugin
            );
