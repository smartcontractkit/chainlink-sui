...
type LockReleaseTokenPoolEmitter interface {
...
type LockReleaseTokenPoolEmitterImpl struct {
	lggr           logger.Logger
	packageId      string
...
func NewLockReleaseTokenPoolEmitter(
	lggr logger.Logger,
	packageId string,
	...
	client sui.ISuiAPI,
	accountAddress string,
) *LockReleaseTokenPoolEmitterImpl {
	...
	if err != nil {
		lggr.Errorw("Failed to create lock_release_token_pool bound contract", "error", err)
		return nil
	}

	return &LockReleaseTokenPoolEmitterImpl{
		lggr:           lggr,
		packageId:      packageId,
...
func (e *LockReleaseTokenPoolEmitterImpl) executePTBCall(ctx context.Context, ptb *transaction.Transaction, addToPTB bool, encodedCall *bind.EncodedCall, operationName string) (*models.SuiTransactionBlockResponse, error) {
	if addToPTB && ptb != nil {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, eventName string) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) BatchEmitEvents(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction) (*models.SuiTransactionBlockResponse, error) {
	if ptb == nil {
		ptb = transaction.NewTransaction()
	}

	e.lggr.Infow("Emitting batch of events for lock release token pool")
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitLockedOrBurnedEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, amount uint64, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitReleasedOrMintedEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, amount uint64, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitRemotePoolAddedEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitRemotePoolRemovedEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitChainAddedEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitChainRemovedEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, remoteChainSelector uint64) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitLiquidityAddedEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, amount uint64) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitLiquidityRemovedEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool, amount uint64) (*models.SuiTransactionBlockResponse, error) {
...
func (e *LockReleaseTokenPoolEmitterImpl) EmitRebalancerSetEvent(ctx context.Context, gasBudget uint64, ptb *transaction.Transaction, addToPTB bool) (*models.SuiTransactionBlockResponse, error) {
