...
stdenv.mkDerivation rec {
  ...
  version = "1.63.3"; # Update as needed. Should be a mainnet release version from https://github.com/MystenLabs/sui/releases
  ...
  src = if stdenv.hostPlatform.isDarwin then
    pkgs.fetchzip {
      ...
      sha256 = "sha256-xbgI7jDUPu8gOqj1kDSZ1hEYMvcjfUcgMbwQTMWFqAk=";  # Should be replaced when bumping versions
      stripRoot = false;
    }
